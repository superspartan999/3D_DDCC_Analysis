# -*- coding: utf-8 -*-
"""
Created on Tue Oct  8 21:05:53 2019
...
material='AlGaN'
#
directory='D:/'+str(length)+'nm'+material
...
file='p_structure_0.17_'+str(length)+'nm_-out.vg_0.00.vd_0.00.vs_0.00.unified'
...
Ecdf=sorted_data[['x','y','z','Electron current','Hole current']].copy()
...
save_json('C:\\Users\\Clayton\\Desktop\\Guillaume\\'+str(length)+'nm'+material+'graph.js',G)