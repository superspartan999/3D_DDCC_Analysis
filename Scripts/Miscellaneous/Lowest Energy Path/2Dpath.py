...
fig = plt.figure()
CS=plt.contourf(x_vals/10e-7,y_vals/10e-7,Ec_array,50,cmap=cm.plasma) 

CS2=plt.contour(x_vals/10e-7,y_vals/10e-7,Ec_array, colors='black',linewidths=0.5)

plt.plot(path['x']/10e-7,path['y']/10e-7)
#plt.clabel(CS2)
